...
class _ConnectionPageState extends State<ConnectionPage>
  ...
  Widget _buildRemoteIDTextField(BuildContext context) {
    // TajDesk stage 31 (variant B): hero-style connect bar. The boxed
    // RustDesk card is replaced by a centred title + a single row: a large
    // pill-shaped ID field (accent outline, leading icon), a pill Connect
    // button, and the options dropdown. All connection logic (autocomplete,
    // onConnect, the Transfer file / Camera / Terminal menu, _isConnecting) is
            ...
            children: [
              Expanded(
                ...
                fieldViewBuilder: (
                  ...
                  // TajDesk stage 31: pill-shaped field wrapper.
                  return Obx(() => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            width: _idInputFocused.value ? 1.6 : 1.2,
                          ),
                        ),
                        child: Row(
                          children: [
              ...
              // TajDesk stage 31: pill Connect button.
              Obx(() => SizedBox(
                    height: 52,
              ...
              const SizedBox(width: 8),
              // TajDesk stage 31: options dropdown (Transfer file / Camera /
              // Terminal) — unchanged logic, restyled to a pill.
              Container(
                height: 52.0,
                width: 46.0,
                decoration: BoxDecoration(
                  color: fieldBg,
                  border: Border.all(
                      color: MyTheme.accent.withOpacity(0.35), width: 1.2),
